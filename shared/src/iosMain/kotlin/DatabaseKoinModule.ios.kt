...
actual val databaseModule: Module = module {
    single<ExpensesDB> { getDatabaseBuilder().setDriver(_root_ide_package_.androidx.sqlite.driver.bundled.BundledSQLiteDriver()).setQueryCoroutineContext(
        Dispatchers.IO).build() }
