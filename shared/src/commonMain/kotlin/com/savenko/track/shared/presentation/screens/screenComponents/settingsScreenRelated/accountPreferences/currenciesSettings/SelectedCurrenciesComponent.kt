...
import com.savenko.track.shared.presentation.screens.states.additional.settings.currenciesSettings.SelectedCurrenciesSettingsState
...
fun SelectedCurrenciesComponent(
    ...
    Column(
        ...
        Row {
            Text(
                text = stringResource(Res.string.message_currencies_settings_screen),
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    stringResource(Res.string.preferable_currency_settings_screen),
                    style = MaterialTheme.typography.bodyMedium
                )
            ...
            OutlinedButton(onClick = { onAction(CurrenciesSettingsScreenEvent.SwitchAdditionalCurrenciesVisibility) }) {
                Text(
                    text = if (state.isAdditionalCurrenciesVisible) {
                        stringResource(Res.string.hide_additional_currencies)
                    } else {
                        stringResource(Res.string.show_additional_currencies)
                    }
                )
            }
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            when (state.error) {
                is CurrenciesSettingsScreenErrors.CurrencyIsAlreadyInUse -> {
                    ...
                    Text(
                        text = stringResource(CurrenciesSettingsScreenErrors.CurrencyIsAlreadyInUse(errorTicker).error,
                            errorTicker
                        ),
                ...
                is CurrenciesSettingsScreenErrors.IncorrectCurrencyConversion -> {
                    Text(
                        text = stringResource(CurrenciesSettingsScreenErrors.IncorrectCurrencyConversion.error),
                        style = MaterialTheme.typography.labelSmall.copy(color = MaterialTheme.colorScheme.error)
                    )
                }
...
private fun CurrenciesMinusTextButton(onClick: () -> Unit) {
    Box(
        ...
        Icon(
            ...
            contentDescription = stringResource(Res.string.delete_latest_currency_settings_screen),
