...
import com.savenko.track.shared.data.other.constants.FIRST_VISIBLE_INDEX_SCROLL_BUTTON_APPEARANCE
import com.savenko.track.shared.data.other.constants.MONTH_SUMMARY_MIN_LIST_SIZE
import com.savenko.track.shared.data.other.converters.dates.isSameDay
import com.savenko.track.shared.data.other.converters.dates.isSameMonth
import com.savenko.track.shared.data.other.converters.dates.isSameYear
            ...
            AnimatedVisibility(visible = isScrollUpButtonNeeded) {
                FloatingActionButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(Res.string.scroll_up_CD)
                    )
                }
            }
        }
