...
import androidx.compose.ui.unit.dp
import com.savenko.track.shared.presentation.screens.screenComponents.settingsScreenRelated.categoriesPreferences.CategoriesScreenOptionsSelector
import com.savenko.track.shared.presentation.screens.screenComponents.settingsScreenRelated.categoriesPreferences.CategoriesSettingsCardViewContent
import com.savenko.track.shared.presentation.screens.screenComponents.settingsScreenRelated.categoriesPreferences.CategoriesSettingsListViewContent
...
fun CategoriesFilterInputField(nameFilter: String, onFilterChange: (String) -> Unit) {
    Row(
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = stringResource(Res.string.filter_categories_categories_screen)) },
            maxLines = 1,
