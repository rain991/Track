...
import com.savenko.track.shared.presentation.other.formatDateAsNumeric
    ...
    Column {
        ...
        if (bottomSheetViewState.warningMessage == BottomSheetErrors.DateNotSelected) {
            ErrorText(
                ...
                text = stringResource(bottomSheetViewState.warningMessage.error)
            )
        }
    }
}
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Center) {
            AnimatedVisibility(visible = isSelected, exit = fadeOut()) {
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.selected_date_add_exp),
                    modifier = Modifier
                        .height(24.dp)
