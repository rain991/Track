        ...
        Column(modifier = Modifier.padding(8.dp)) {
                ...
                Text(
                    text = when (T::class) {
                        ExpenseCategory::class -> {
                            stringResource(Res.string.expense_categories_categories_settings_screen)
                        }

                        IncomeCategory::class -> {
                            stringResource(Res.string.income_categories)
                        }
            ...
            if (categoriesList.isEmpty()) {
                Row(
                    ...
                    Text(text = stringResource(Res.string.no_categories_for_specified_filters_categories_settings), textAlign = TextAlign.Center)
                }
            } else {
                FlowRow(
                    modifier = Modifier.fillMaxWidth(),
