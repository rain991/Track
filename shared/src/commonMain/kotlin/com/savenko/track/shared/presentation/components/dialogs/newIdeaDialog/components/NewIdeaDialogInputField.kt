package com.savenko.track.shared.presentation.components.dialogs.newIdeaDialog.components
...
import com.savenko.track.shared.data.other.constants.MAX_IDEA_VALUE
...
@Composable
fun NewIdeaDialogInputField(preferableCurrency: Currency) {
