package com.savenko.track.shared.data.viewmodels.login
...
import com.savenko.track.shared.presentation.screens.states.core.loginScreen.LoginScreenState
...
class LoginScreenViewModel(
    ...
    suspend fun addToDataStore(dispatcher: CoroutineDispatcher = Dispatchers.Default) {
