package com.savenko.track.shared.presentation.screens.screenComponents.settingsScreenRelated.additionalPreferences
...
import com.savenko.track.shared.presentation.screens.core.SettingsTrackScreen
...
fun SettingsScreenAdditionalPreferences(modifier: Modifier) {
    ...
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Row(modifier = Modifier.padding(start = 8.dp)) {
            Text(
                text = stringResource(Res.string.additional),
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.allow_non_categorised_expenses),
            ...
            if (state.value.nonCategorisedExpenses && !isExpenseCategorySelectionVisible && state.value.groupingExpensesCategoryId != GROUPING_CATEGORY_ID_DEFAULT && selectedExpenseCategory != null) {
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                    Text(
                        text = stringResource(Res.string.show_as),
                        style = MaterialTheme.typography.bodyMedium.copy(color = MaterialTheme.colorScheme.onPrimary),
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.allow_non_categorised_incomes),
                    style = MaterialTheme.typography.bodyMedium.copy(color = MaterialTheme.colorScheme.onPrimary),
                    textAlign = TextAlign.Start
                )
