package com.savenko.track.shared.data.database.expensesRelated
...
interface ExpenseItemsDAO {
    ...
    suspend fun getCategoriesByExpenseItemIds(listOfIds: List<Int>): List<ExpenseCategory>
    ...
    suspend fun findExpenseById(id: Int): ExpenseItem?
    ...
    suspend fun findExpensesInTimeSpan(start: Long, end: Long, categoryId: Int): List<ExpenseItem>
