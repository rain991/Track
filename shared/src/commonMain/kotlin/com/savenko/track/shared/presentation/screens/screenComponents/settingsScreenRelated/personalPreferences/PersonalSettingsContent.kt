...
import com.savenko.track.shared.data.other.constants.MAX_BUDGET_VALUE
import com.savenko.track.shared.data.other.constants.NAME_MAX_LENGTH
...
private fun DefaultContent(name: String, budget: Float, preferableCurrency: Currency, onEditButtonClick: () -> Unit) {
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(Res.string.name_personal_settings_screen, name),
                modifier = Modifier.weight(1f)
            )
            IconButton(onClick = { onEditButtonClick() }) {
                Icon(
                    imageVector = Icons.Default.Create,
                    contentDescription = stringResource(Res.string.edit_personal_info)
                )
            }
        }
        ...
        Text(
            text = stringResource(
                Res.string.budget_personal_settings_screen,
                budget,
...
private fun EditModeContent(
    ...
    Column(
        ...
        val nameLabel = stringResource(Res.string.new_name_personal_settings_screen)
        Spacer(modifier = Modifier.height(8.dp))
        ...
        val budgetLabel = stringResource(Res.string.new_budget_personal_settings_screen, preferableCurrency.ticker)
        Spacer(modifier = Modifier.height(16.dp))
