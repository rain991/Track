package com.savenko.track.shared.presentation.screens.loginScreen
...
import com.savenko.track.shared.presentation.components.customComponents.AutoResizedText
    ...
    Card(
        ...
        Column(
            ...
            FlowRow(
                ...
                Text(
                    text = stringResource(Res.string.aprox_month_income_login_screen
                    ),
                    style = MaterialTheme.typography.bodyMedium,
                    textAlign = TextAlign.Center,
                    color = MaterialTheme.colorScheme.onPrimary,
