package com.savenko.track.shared.presentation.screens.screenComponents.settingsScreenRelated.accountPreferences.currenciesSettings
...
import androidx.compose.ui.unit.dp
import com.savenko.track.shared.data.other.constants.CURRENCIES_FILTER_MAX_LENGTH
...
import com.savenko.track.shared.presentation.screens.states.additional.settings.currenciesSettings.CurrenciesSettingsScreenEvent
...
fun CurrencyListComponent(
    ...
    var inputTextFilter by rememberSaveable { mutableStateOf("") }
    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text(text = stringResource(Res.string.filter_currencies)) },
                maxLines = 1,
    ...
    Row(
        ...
        Box(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                Text(text = stringResource(databaseStringResourcesProvider.provideCurrencyStringResource(currency.ticker)))
            ...
            DropdownMenu(
                ...
                listOfOptions.forEachIndexed { index, selectionOption ->
                    DropdownMenuItem(
                        text = {
                            Text(
                                text = stringResource(selectionOption.messageResId),
...
private sealed class CurrenciesSettingsSelectionOption(val messageResId: StringResource) {
    data object SetPreferableCurrency :
        CurrenciesSettingsSelectionOption(messageResId = Res.string.set_as_preferable_currency_currencies_settings)

    data object SetFirstAdditionalCurrency :
        CurrenciesSettingsSelectionOption(messageResId = Res.string.set_as_first_priority_additional)

    data object SetSecondAdditionalCurrency :
        CurrenciesSettingsSelectionOption(messageResId = Res.string.set_as_second_priority_additional)

    data object SetThirdAdditionalCurrency :
        CurrenciesSettingsSelectionOption(messageResId = Res.string.set_as_third_priority_additional)

    data object SetFourthAdditionalCurrency :
        CurrenciesSettingsSelectionOption(messageResId = Res.string.set_as_fourth_priority_additional)
}
